  ...
  return (
    <div  className='flex items-center justify-between max-sm:flex-col-reverse gap-y-7 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500 '>Upload any image and instantly remove its background <br  className='max-sm:hidden' /> with AI — no design skills needed, completely free.</p>
        <div>
