...
const Header = () => {
  ...
  return (
    <div  className='flex items-center justify-between max-sm:flex-col-reverse gap-y-7 px-4 mt-10 lg:px-44 sm:mt-20'>
        {/* -------Left Side-------- */}
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500 '>Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br  className='max-sm:hidden' /> Itaque quos aliquid fuga adipisci aut fugiat, officiis maiores earum.</p>
        <div>
